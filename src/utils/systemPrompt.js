...
// 출처: SW사업 대가산정 가이드 공식 산정양식 (KOSA 2024)
// ============================================================
...
| 사용자메뉴 | 서비스가이드 | 시스템 도움말 | ILF | 1 | 5 | L | 7 |
| 사용자메뉴 | 서비스가이드 | 시스템 도움말 조회 | EQ | 1 | 5 | L | 3 |
| 사용자메뉴 | 서비스가이드 | FAQ | ILF | 1 | 5 | L | 7 |
| 사용자메뉴 | 서비스가이드 | FAQ 등록 | EI | 1 | 4 | L | 3 |
| 사용자메뉴 | 서비스가이드 | FAQ 수정 | EI | 1 | 4 | L | 3 |
| 사용자메뉴 | 서비스가이드 | FAQ 삭제 | EI | 1 | 4 | L | 3 |
| 사용자메뉴 | 서비스가이드 | FAQ 조회 | EQ | 1 | 4 | L | 3 |
| 사용자메뉴 | 회원 | 회원 DB | ILF | 2 | 30 | A | 10 |
| 사용자메뉴 | 회원등록 | 회원가입 | EI | 2 | 30 | H | 6 |
| 사용자메뉴 | 회원등록 | 회원탈퇴 | EI | 2 | 30 | H | 6 |

### 예시2: 재개발 시스템 (간이법)
| 단위프로세스명 | FP유형 | FTR | DET | 가중치 | 재사용유형 |
|---|---|---|---|---|---|
| 회의실 사용신청 정보 | ILF | - | 20 | 7.5 | 기능변경 |
| 회의실 사용실적 정보 | ILF | - | 15 | 7.5 | 기능변경 |
| 회의실 정보 | ILF | - | 10 | 7.5 | 기능삭제 |
| 회의실 신청 등록 | EI | 2 | 27 | 4 | 기능변경 |
| 회의실 신청 수정 | EI | 2 | 22 | 4 | 기능변경 |
| 회의실 신청 삭제 | EI | 2 | 5 | 4 | 기능변경 |
| 회의실 대여료 계산 | EO | 2 | 7 | 5.2 | 기능변경 |
| 회의실 신청 조회 | EQ | 2 | 30 | 3.9 | 기능변경 |
| FAQ | ILF | - | 5 | 7.5 | 신규개발 |
| FAQ 등록 | EI | 1 | 7 | 4 | 신규개발 |
...
// FP 산정 프롬프트 (핵심 규칙 + Few-shot 예시 포함)
