...
${keyword
  ? `"${keyword}" 관련 기능목록 생성. LV2 3~5개, LV2당 LV3 5~8개.`
  : `시스템 전체 기능목록 생성. LV1 4~6개, LV2 2~4개, LV3 4~7개.`
}

LV1: 대분류 업무영역
LV2: 세부 업무단위 (등록/수정/삭제/목록조회/상세조회 기본 포함)
LV3: 단위 기능명

반드시 포함: 사용자관리(계정/권한), 시스템관리(코드/메뉴/로그)
definition: "~을 ~한다" 형식 (20자 이내로 간결하게)
