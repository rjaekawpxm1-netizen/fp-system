...
- LV1 개수: 최소 5개, 최대 15개 (요구사항 규모에 비례)
- 요구사항이 없는 도메인 절대 생성 금지
- 공통기능(사용자/권한/시스템관리) 항상 마지막에 포함

## 절대 LV1으로 만들면 안 되는 것 (실제 오류 사례)
❌ AI/ML 기반 지능형 운영 → 기술 방법론, 시스템 기능 아님
❌ 운영 자동화 및 AIOps → 인프라 운영 개념
❌ 클라우드 및 인프라 고도화 → 하드웨어/인프라 영역
❌ 아키텍처 설계 및 최적화 → 컨설팅 과업
❌ 실시간 데이터 스트리밍 → 기술 플랫폼
❌ 연동보안 사고대응 및 포렌식 → 보안관리로 통합
❌ 비즈니스연속성관리 → 재해복구관리로 통합
→ 위와 유사한 이름은 기존 LV1에 통합하거나 제외

## LV1 통합 기준
- 보안 관련 여러 개 → "보안관리" 하나로 통합
- 운영 관련 여러 개 → "운영관리" 하나로 통합
- 분석/통계 관련 → "통계및분석" 하나로 통합
